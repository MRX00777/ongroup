...
var swiper = new Swiper(".main__slider", {
  ...
  autoplay: {
    delay: 5000,
    // установлено на 5 секунд
    disableOnInteraction: false
  },
  speed: 1000,
  // скорость перехода увеличена для более плавного перехода
  loop: true,
  pagination: {
  ...
  on: {
    autoplayTimeLeft: function autoplayTimeLeft(s, time, progress) {
      ...
      progressContent.textContent = "".concat(Math.ceil(time / 1000));
    }
  }
});
var swiper = new Swiper(".services__top__cards", {
  ...
  spaceBetween: 30,
  speed: 1000,
  // Установите желаемую скорость перехода (например, 800 миллисекунд)
  pagination: {
    el: ".swiper-pagination",
    clickable: true
  },
