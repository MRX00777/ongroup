                    ...
                    <div class="top__row">
                        <div class="top__row__left">
                            <div class="top__row__left-title">
                                Разработка современных сайтов 🖥️
                            </div>
                            <p>Профессиональная разработка сайтов любой сложности. Создадим современные, адаптивные и
                                функциональные веб-решения.</p>
                ...
                <div class="top">
                    ...
                    <div class="top__row">
                        <div class="top__row__left">
                            ...
                            <p>Telegram-боты упрощают взаимодействие с клиентами, автоматизируют заказы и улучшают
                                поддержку. </p>
                            <a href="" class="top__row__left-link">
            ...
            <div class="swiper-slide">
                <div class="top">
                    ...
                    <div class="top__row">
                        <div class="top__row__left">
                            <div class="top__row__left-title">
                                Интеграция программ и AI-решений 💡
                            </div>
                            <p>Автоматизируйте бизнес-процессы с помощью интеграции ChatGPT, AmoCRM, Битрикс24,
                                социальных сетей и других сервисов.</p>
                            <a href="" class="top__row__left-link">
